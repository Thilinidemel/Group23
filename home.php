    ...
    <div class="header">
      ...
      <div class="header_middle">
        <div class="header_option active">
          <abbr title="Home"><span class="material-icons"> home </span></abbr>
        </div>
        <div class="header_option">
          <abbr title="Female Clothings"><span class="material-icons"> girl </span></abbr>
        </div>
        <div class="header_option">
          <abbr title="Male Clothings"><span class="material-icons"> boy </span></abbr>
        </div>
        <div class="header_option">
          <abbr title="Kids Section"><span class="material-icons"> child_friendly </span></abbr>
        </div>
        <div class="header_option">
          <abbr title="Cart"><span class="material-icons"> shopping_cart </span></abbr>
        </div>
      </div>
